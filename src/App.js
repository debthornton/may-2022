...
const ViewWorks = React.lazy(() =>
  import(/* webpackChunkName: "views-error" */ './views/works')
);
const ViewContact = React.lazy(() =>
  import(/* webpackChunkName: "views-error" */ './views/contact')
);
